...
def askPrograms():
  listaProgramasAPT = ['git','libreoffice','arduino','snapd','libqt5designer5','sequeler','spectator','qttools5-dev-tools','pyqt5-dev-tools','com.github.mohelm97.screenrecorder','franz']
  listaProgramasSNAP = ['intellij-idea-community','android-studio']
